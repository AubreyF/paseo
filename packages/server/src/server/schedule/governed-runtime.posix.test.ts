...
test("loads an explicitly installed runtime and rejects invalid exports without fallback", async () => {
  ...
  try {
    ...
    await expect(loadGovernedScheduleRuntimeFactory(invalid)).rejects.toThrow("export is missing");
