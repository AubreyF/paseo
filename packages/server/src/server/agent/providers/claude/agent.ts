...
export class ClaudeAgentClient implements AgentClient {
  ...
  async fetchCatalog(options: FetchCatalogOptions): Promise<ProviderCatalog> {
    ...
    try {
      claudeCodeVersion = workspace
        ? await resolveWorkspaceClaudeCodeVersion(workspace, this.runtimeSettings)
    ...
    const models = workspace
      ...
      : await getClaudeModelsWithSettings(this.logger, this.configDir, claudeCodeVersion);
