...
- Keep composer preset and permission selectors on one row. Abbreviate permission captions only when measured content exceeds available width; retain full menu and accessibility labels.
